...
var themeImportsMap = {
  ...
  'light-saturated-palette-changes': function lightSaturatedPaletteChanges() {
    return Promise.resolve().then(function () {
      return _interopRequireWildcard(require( /* webpackChunkName: "@atlaskit-internal_atlassian-light-saturated-palette-changes" */
      './themes/atlassian-light-saturated-palette-changes'));
    });
  },
  'dark-saturated-palette-changes': function darkSaturatedPaletteChanges() {
    return Promise.resolve().then(function () {
      return _interopRequireWildcard(require( /* webpackChunkName: "@atlaskit-internal_atlassian-dark-saturated-palette-changes" */
