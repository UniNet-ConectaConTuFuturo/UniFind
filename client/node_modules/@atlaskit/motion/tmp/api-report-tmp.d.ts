...
// @public (undocumented)
type AnimationCurve = 'cubic-bezier(0.15,1,0.3,1)' | 'cubic-bezier(0.2,0,0,1)' | 'cubic-bezier(0.8,0,0,0.8)';
...
// @public
export const ExitingPersistence: React_2.MemoExoticComponent<({ appear: appearFromProp, children: childs, exitThenEnter, }: ExitingPersistenceProps) => any>;
...
// @public
export const FadeIn: ({ children, duration, entranceDirection, exitDirection, distance, onFinish, isPaused, }: FadeKeyframesMotionProps) => JSX.Element;
...
// @public
export const SlideIn: ({ children, enterFrom, exitTo, fade, duration, isPaused, onFinish, animationTimingFunction, }: SlideInProps) => JSX.Element;
...
// @public
export const StaggeredEntrance: ({ children, column, columns, delayStep, }: StaggeredEntranceProps) => JSX.Element;
...
// @public
export const useResizingHeight: ({ duration: calcDuration, timingFunction: calcTimingFunction, }?: ResizingHeightOpts) => {
    ref: CallbackRef;
};

// @public
export const ZoomIn: ({ children, duration, isPaused, onFinish, }: KeyframesMotionProps) => JSX.Element;
