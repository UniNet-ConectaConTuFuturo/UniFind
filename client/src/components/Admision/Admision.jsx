  ...
  const getItems = (panelStyle) => [
    {
      ...
      style: panelStyle,
      children:
        solicitud.pendiente && solicitud.pendiente.length ? (
          <List
    ...
    },
    {
      ...
      style: panelStyle,
      children:
        solicitud.aceptada && solicitud.aceptada.length ? (
          <List
    ...
    },
    {
      ...
      style: panelStyle,
      children:
        solicitud.rechazada && solicitud.rechazada.length ? (
          <List
    ...
    },
    {
      ...
      style: panelStyle,
      children:
        solicitud.segunda_instacia && solicitud.segunda_instacia.length ? (
          <List
